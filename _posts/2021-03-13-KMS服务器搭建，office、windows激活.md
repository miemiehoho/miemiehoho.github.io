...
- 进入对应的目录。比如Debian9，我们可以进入binaries/Linux/intel/static目录中
...
```
./vlmcsdmulti-x86-musl-static vlmcsd
```
...
- 设置KMS激活服务器地址（kms.srv.crsoo.com）改为KMS服务器地址
